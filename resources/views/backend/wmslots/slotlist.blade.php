...
<div class="right_col" role="main">
        ...
        @if ($message = Session::get('success'))
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panell">
                        <div class="x_title">
                            <button style="margin-left:10px" class="btn green-gradient" data-toggle="modal" data-target="#ex1"> <i class="fa fa-plus"></i> Create WM Slot</button>
                            <div class="clearfix"></div>
                        </div>
               ...
               foreach($data as $slots) 
               {
                ...
                // dd($slots->hub_id);
                 ...
                 echo "<td>";
                 echo "<button type='button'  class='delete btn btn red-gradient actBtn' data-id='".$slots->id."'>Delete <i class='fa fa-trash'></i></button>";
                 echo "<button type='button'  class='update btn btn green-gradient actBtn' data-id='".$slots->id."'>Edit <i class='fa fa-pencil'></i></button>";
                 echo "<button type='button'  class='details btn btn orange-gradient actBtn' data-id='".$slots->id."'>Details <i class='fa fa-eye'></i></button>";
    ...
    <div id="ex1" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <div class='modal-content'>
                ...
                <form action="{{URL::to('/backend')}}/wm/slots/create" method="post">

                	  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="store_num" value="<?php echo $id ?>">
			          ...
			          <div class="form-group">
			              ...
			              <input type="number" name="joey_count" id="joey_count" class="form-control" min='0' required/>    
			          </div>
    ...
    <div id="ex2" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <div class='modal-content'>
                ...
                <form action="{{URL::to('/backend')}}/wm/slots/update" method="post">
		          ...
		          <div class="form-group">
		              <label>Joeys Count</label>
		              <input type="number" name="joey_count_edit" id="joey_count_edit" class="form-control" min='0' required/>    
		          </div>
    ...
    <div id="ex4" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <form action="{{URL::to('/backend')}}/wm/slots/deleteslot" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <div id="ex10" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <form action="{{URL::to('/backend')}}/wm/slot/route/create" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" id="slot_idd" name="slot_idd" value="">


                    <div class="form-group">
                        <p><b>Are you sure you want to Create Route ?</b></p>
                    </div>
                    <div class="form-group">
                      <button type="submit" class="btn green-gradient btn-xs" >Yes</button>
                      <button type="button" class="btn red-gradient btn-xs" data-dismiss="modal" >No</button>
...
$(document).ready(function(){
  $(".details").click(function(){
    ...
    $.ajax({
        ...
        url: b_url+'/wm/slots/'+del_id+'/detail',
        ...
        {   
         a = JSON.parse(data);
          console.log(a);
           ...
           $('#store_num_d').html(''+a['data']['store_num']);
...
$(document).ready(function(){
  $(".update").click(function(){
    ...
    $.ajax({
        type: "GET",
        url: b_url+'/wm/slots/'+del_id+'/update',
        success: function(data)
        {   
