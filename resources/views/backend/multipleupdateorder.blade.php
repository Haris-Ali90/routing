...
@section('title', 'Multiple Status Update')
...
<div class="x_title">
<h2>Multiple Status Update<small></small></h2>
</div>
                        <div class="x_title">
                          <form method="post" action="../../update/multiple/trackingid" class="d-flex">
                            <input type="hidden" name="_token" class="form-control" value="{{ csrf_token() }}">
                              
                           <div class="col-lg-3">
                           <textarea required style=" margin-bottom:5px; border-radius: 5px; margin-right:5px; line-height:28px !important" name="tracking_id"  class="form-control"
                                placeholder="Tracking Id eg:Test-order001" title='Search with multiple tracking Id.' value="" ></textarea>
                           </div>
                               
                               <div class="col-lg-3">
                               <select  id="status_id" class="form-control" name="status_id"  class="js-example-basic-single" required > 
                                 ...
                                 <button class="btn t sub-ad btn-primary" type="submit" style="margin-top: -3%,4%">Update </button>
