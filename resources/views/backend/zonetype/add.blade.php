            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        {!! Form::open( ['url' => ['backend/zonestypes/create'], 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                        @include( 'backend.zonetype.form' )
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
