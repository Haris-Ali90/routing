                        ...
                        <div class="x_title">
                          ...
                          <form method="get" action="">
                             ...
                             <label>Search By Date</label>
                                ...
                                ?>
                                 <input type="date" name="date" required="" placeholder="Search" class="form-control" value="<?php echo $date ?>">
                             </div>
                              </div>
                               <div class="col-lg-3">
                               <button class="btn green-gradient sub-ad" type="submit" style="margin-top: 12px">Go</a> </button>
                               </div>
                               <div class="col-lg-6 d-flex justify-content-end">
                               <a class="btn green-gradient sub-ad" href="{{ backend_url('montreal/routes') }}" style="margin-top: 12px"></i>Actual  Routes</a>
                               </div>
                             </div>
                           </form>
...
for($j=0;$j<count($counts);$j++) {
    ...
    echo "<td><button  title='Details' class='details green-gradient btn' data-route-id=" . $counts[$j]->route_id . " data-joey-id=" . $counts[$j]->joey_id . " >D</button>
     <a class=' orange-gradient btn' target='_blank' href='../../route/" . $counts[$j]->route_id . "/edit/hub/16' title='Edit Route'>E</a> 
