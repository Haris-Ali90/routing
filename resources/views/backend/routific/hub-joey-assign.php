...
$routes = \JoeyCo\Laravel\JoeyRoute::where_null('deleted_at')->where('date','like',$date.'%')->get();
$joeys = \JoeyCo\Laravel\Joey::where_null('deleted_at')->where_not_null('hub_joey_type')->where('is_enabled','=',1)->where_null('email_verify_token')->order_by('first_name')->get();
...
<section class="content">
            ...
            <h2 style="width:100%; background-color:#3e3e3e; color:white; text-align:center; font-size:20px; font-weight:bold; margin-bottom:25px; padding:10px 0px">Assign Hub Routes to Sorter</h2>
            ...
            <a class='button green-gradient' href='sorter/graph' >Sorter Dashboard</a>
        ...
        <table class="data-table orders-table">
            ...
            <tbody>
             ...
             foreach($hubroutes as $route) {
                 ...
                 echo "<td>".$status."</td>";
                 echo "<td><button type='button' class='details button green-gradient' data-route-id=".$route->route_id." data-joey-id=".$orders->joey_id." >Details</button> | <a class='button orange-gradient' href='hub/route/".$route->attributes['route_id']."/joey/".$route->attributes['joey_id']."/delete'>Delete</a> | <a class='button red-gradient' href='hub/sorter/".$route->attributes['route_id']."/edit' >Edit</a></td>";
...
<div id="ex1" class="modal" style="display: none"> 
 ...
 <form action="/route/assign/add" method="post">
    ...
    <div class="form-group">
        ...
        <select class="form-control s" name="joey_id">
         <option disabled selected>Please Select</option>
            <?php 
