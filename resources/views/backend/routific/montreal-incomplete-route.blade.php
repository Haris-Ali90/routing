...
@section('title', 'Montreal Incomplete Routes')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3>Montreal Incomplete Routes<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <a class="btn green-gradient" href="{{ backend_url('montreal/routes') }}"></i>Complete Routes</a>
                            <div class="clearfix"></div>
                        </div>
