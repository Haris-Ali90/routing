...
@section('title', 'Scarborough Deleted Routes')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3>Scarborough Deleted Routes<small></small></h3>
                </div>
            </div>
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                        <a class="btn green-gradient" href="{{ backend_url('ctc/routes') }}"></i>Actual Routes</a>
