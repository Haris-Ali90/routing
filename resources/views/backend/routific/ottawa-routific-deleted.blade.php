                        ...
                        <div class="x_title">
                          <form method="get" action="">
                                ...
                                ?>
                                 ...
                                 <div class="col-lg-3">
                                 <button class="btn green-gradient sub-ad" type="submit" style="margin-top: 10px">Go</a> </button>
                                 </div>
                                <div class="col-lg-6 d-flex justify-content-end">
                                <a class="btn green-gradient sub-ad" href="{{ backend_url('ottawa/routes') }}"></i>Actual  Routes</a>
                                </div>
                                </div>
                           </form>
