        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3>Mark out for delivery<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                ?> 
                        ...
                        <form id="filter"  style="padding: 10px;" action="../routific/outfordelivery" method="get">  
...
<form id="filter" name='typeCV' style="padding: 10px;" action="outfordelivery/status" method="post">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="sprint_id" >
                <select   id="sprint_id" name="route_id[]" style="width:45%;  float:left;" multiple class="form-control chosen-select" required > 
    
                @forelse ($sprint as $user)
                ...
                <button style="padding: 7px;margin: 0;" id="search" type="submit" class="btn green-gradient">Out For Delivery</button>
        </div>
              </form>
