...
@section('title', 'Scarborough Routes')
        ...
        @if ($message = Session::get('success'))
            ...
            <div class="page-title">
                <div class="title_left amazon-text">
                    <!-- <h3>Scarborough Routes<small></small></h3> -->
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-3">
                ...
                <button  id="search" type="submit" class="btn green-gradient sub-ad" style="margin:2px 0px 0px 0px !important">Submit</button>
...
{{--New add--}}
                    ...
                    {{--end--}}
                        <div class="x_title">
                             <button type='button'  class='dselect btn btn green-gradient actBtn sub-ad' data-toggle='modal' data-target='#ex50' onclick='fullmap()' >Map <i class='fa fa-map'></i></button>
...
for($j=0;$j<count($counts);$j++) {
   ...
   $counts_total = $counts_total + $counts[$j]->counts;
    ...
    echo "<td><button class='details green-gradient btn col-lg-2 col-md-3 col-sm-2 px-auto' data-route-id=" . $counts[$j]->route_id . " data-joey-id=" . $counts[$j]->joey_id . " title='Details'>D</button>
