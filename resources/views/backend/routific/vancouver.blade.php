...
@section('title', 'Vancouver Routes')
...
<button class='green-gradient btn col-lg-2 col-md-3 col-sm-2 px-auto multiple-details' data-routeid=" . $counts[$j]->route_id . " data-joeyid=" . $counts[$j]->joey_id . ">D</button>
     ...
     <a class=' orange-gradient btn' target='_blank' href='../route/" . $counts[$j]->route_id . "/edit/hub/129' title='Edit Route'>E</a>
...
function fullmap() {
    ...
    <?php    if(empty($_REQUEST['date'])){
                ...
                $.ajax({
                    ...
                    url : '../../backend/allroute/477607/location/joey?date=<?php echo $date; ?>',
                    type : 'GET',
                    dataType:'json',
                    success : function(data) {
                        console.log(data);
