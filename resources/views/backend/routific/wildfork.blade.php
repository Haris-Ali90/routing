        ...
        @if ($message = Session::get('success'))
            ...
            <div class="page-title">
                <div class="title_left amazon-text">
                    <!-- <h3>Wildfork Routes<small></small></h3> -->
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <button  id="search" type="submit" class="btn green-gradient sub-ad">Submit</button>
              </div>
