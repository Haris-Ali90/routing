        ...
        @if ($message = Session::get('success'))
            ...
            <div class="row">
              ...
              <input id="date" name="date" style="width:35%px" type="date" placeholder="date" value="<?php echo $date ?>"  class="form-control">
                ...
                <button  id="search" type="submit" class="btn  sub-ad green-gradient">Submit</button>
                        ...
                        <div class="x_title">
                             <button type='button'  class='dselect btn btn green-gradient sub-ad actBtn' data-toggle='modal' data-target='#ex50' onclick='fullmap()' >Map <i class='fa fa-map'></i></button>
...
//Not Delivered Counts
    ...
    <button class='green-gradient btn col-lg-2 col-md-3 col-sm-2 px-auto multiple-details' data-routeid=" . $counts[$j]->route_id . " data-joeyid=" . $counts[$j]->joey_id . ">D</button>
     ...
     <a class=' orange-gradient btn' target='_blank' href='../route/" . $counts[$j]->route_id . "/edit/hub/19' title='Edit Route'>E</a> 
...
{{--                          <button class='details green-gradient btn' data-route-id=" . $counts[$j]->route_id . " data-joey-id=" . $counts[$j]->joey_id . " title='Details'>D</button>--}}
                            </table>
	                </div>
...
<script>
    ...
    $(document).on('click', '.multiple-details', function(e) {
        ...
        var modal = "<div style='margin-left: "+marginDiv+"px' onclick='divUpperOnPage("+routeId+")'>" +
            ...
            "<div id='"+divHeader+"' class='mydivheader' style='margin-bottom: 15px;'>" +
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.routes.forEach(function(route) {
                    ...
                    var heading = "<h4 class='route-detail-h4'>R-" + route.route_id +'-'+route.ordinal+ "</h4>";
...
function fullmap() {
    ...
    <?php    if(empty($_REQUEST['date'])){
                ...
                $.ajax({
                    ...
                    url : '../../backend/allroute/477282/location/joey?date=<?php echo $date; ?>',
                    type : 'GET',
                    dataType:'json',
                    success : function(data) {
                        console.log(data);
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i]['type'] == "dropoff") {
                ...
                bounds.extend(latlng);
                    ...
                    position: latlng,
                    map: map,
                    icon: "https://assets.joeyco.com/images/map/pins/big/default.png",
                    title:   "JOEY"
                });
