...
<div class="right_col" role="main">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                        <h2>Search Orders<small></small></h2>
                            <div class="clearfix"></div>
                        </div>
                
                        <div class="x_title">
                            
                        <form method="get" action="" id="" class="d-flex">   
    ...
    <textarea rows='1' cols="180"  name="tracking_id" id="tracking_ids" class="form-control" onchange="disableOrEnablebutton(this.value)"
                                                   value="" style="margin-top:5px; margin-bottom:5px; border-radius: 5px; margin-right:5px;line-height:28px !important; float: left"
                                                   placeholder="Tracking Id eg: Test-order-001" title='Search with multiple tracking Id.'></textarea>
    </div>
                                       ...
                                       <textarea rows='1' cols="180"  name="phone_no"  id="phone_no" class="form-control" onchange="disableOrEnablebutton(this.value)"
                                                   value="" style="line-height:28px !important;margin-top:5px; border-radius: 5px; margin-bottom:5px; margin-right:5px;float: left"
                                                   placeholder="Phone No eg:phone001,phone002" title="Search  with multiple phone no."></textarea>
                                       </div>
                                       
                                        <button class="btn sub-ad btn-primary" id="search_btn" type="submit" style="margin-top:7px; margin-bottom:5px;  margin-right:5px;float: left" >Search </button>
                                        ...
                                        <!-- csv download btn -->
                                        <?php $date = date('Y-m-d');  ?>
                                        <button onclick="exportTableToCSV('tracking-details-<?php echo $date ?>.csv')" style="margin-top:7px; margin-bottom:5px;  margin-right:5px;float: left" type="button" class="btn sub-ad btn-primary">Generate Report in CSV</button>
                </div>
                               </form>
                                     ...
                                     foreach($status as $key => $oc){ ?>
                                      ...
                                      ?>
                                        ...
                                        <a class="Status btn green-gradient btn"  data-id='<?php echo $response->id; ?>'>Update Status</a>
                                           <a  class="btn  sub-ad btn-primary btn" href="../../search/orders/trackingid/<?php echo $response->id; ?>/details">Details</a>     
                                        </td>
                                    </tr>
                                    <?php
                                } 
