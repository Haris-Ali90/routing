        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Donor <small>Donors listing</small></h2>
                                ...
                                @foreach( $users as $record )
                                    <tr class="">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ backend_url('donor/profile/'.$record->id) }}" class="btn btn-primary btn-xs" style="float: left;"><i class="fa fa-folder"></i> </a>
                                            <?php  if(count($data)== 0 || (count($dataPermission)>0 && in_array("edit", $dataPermission))){  ?>
                                            <a href="{{ backend_url('donor/edit/'.$record->id) }}" class="btn btn-info btn-xs edit" style="float: left;"><i class="fa fa-pencil"></i>  </a>
<?php } ?>
<?php  if(count($data)== 0 || (count($dataPermission)>0 && in_array("delete", $dataPermission))){  ?>
                                            {!! Form::model($record, ['method' => 'delete', 'url' => 'backend/donor/'.$record->id, 'class' =>'form-inline form-delete']) !!}
