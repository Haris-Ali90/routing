        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <form method="post" action="../../backend/update/manual/route">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <textarea class="custmtextarea" required style=" margin-bottom:5px; border-radius: 5px; margin-right:5px;" name="route_id"
                                placeholder="Route Id eg:16044,16045" title='Search with multiple route Id.' value="" ></textarea> 
