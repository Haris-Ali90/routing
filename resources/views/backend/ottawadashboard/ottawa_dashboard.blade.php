...
@section('JSLibraries')
    ...
    <script src="{{ backend_asset('css/jquery-ui.css')}}"></script>
@endsection
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 style="margin-left: 43%;">Ottawa Dashboard<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                          <form method="get" action="ottawa_dashboard">
                                <label>Search By Date</label>
                                 <input class="datepicker" type="text" id="datepicker" name="datepicker" required="">
                    ...
                    @foreach( $ottawa_dash as $record )
                      <tr>
                        ...
                        <td><a href="{{backend_url('ottawa/profile/'.$record->id)}}" class="btn btn-primary btn-xs" style="float: left;"><i class="fa fa-folder"></i></a>
                        </td>
