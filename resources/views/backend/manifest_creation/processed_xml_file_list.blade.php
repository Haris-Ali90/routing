...
@section('title', 'Processed XML File')
...
@section('content')
    ...
    <div class="right_col" role="main">
        @php
            $splittedFilesCount = App\ProcessedXmlFiles::splittedFilesCount();
            $splittedProcessFilesCount = App\ProcessedXmlFiles::splittedProcessFilesCount();
            $splittedCompleteFilesCount = App\ProcessedXmlFiles::splittedCompleteFilesCount();
            $splittedDuplicateFilesCount = App\ProcessedXmlFiles::splittedDuplicateFilesCount();
            $showDeleteButtonQuery = App\ProcessedXmlFiles::showDeleteButtonQuery();
            $mainFile=[];
        @endphp
        @foreach($processedXmlFile as $key => $data)
            @php
                ...
                if(isset($fileName[1]) && isset($fileName[2])){
                   $mainFile[] = 'EDI_'.$fileName[1].'_'.$fileName[2];
                }
            @endphp
        @endforeach
                ...
                <div class="top_tiles montreal-dashbord-tiles">
                    <div class="animated flipInY col-md-12 col-sm-12 ">
                        <div class="tile-stats">
                            ...
                            <div class="count">{{ count(array_unique($mainFile)) }}</div>
                    ...
                    <div class="top_tiles montreal-dashbord-tiles">
                        <div class="animated flipInY  col-md-12 col-sm-12 ">
                            <div class="tile-stats">
                                ...
                                <div class="count">{{ isset($splittedFilesCount) ? $splittedFilesCount : 0 }}</div>
                                <h3>Splitted Files Count</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="top_tiles montreal-dashbord-tiles">
                    <div class="animated flipInY  col-md-12 col-sm-12 ">
                        <div class="tile-stats">
                            ...
                            <div class="count">{{ ($splittedProcessFilesCount) ? $splittedProcessFilesCount : 0 }}</div>
                            <h3>Process Splitted Files Count</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="top_tiles montreal-dashbord-tiles">
                    <div class="animated flipInY  col-md-12 col-sm-12 ">
                        <div class="tile-stats">
                            ...
                            <div class="count">{{ ($splittedCompleteFilesCount) ? $splittedCompleteFilesCount : 0 }}</div>
                            <h3>Completed Splitted Files Count</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="top_tiles montreal-dashbord-tiles">
                    <div class="animated flipInY  col-md-12 col-sm-12 ">
                        <div class="tile-stats">
                            ...
                            <div class="count"> {{ count($splittedDuplicateFilesCount) }}</div>
                            <h3>Duplicate Splitted Files Count</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="headingGrid_divider">
                <div class="gridCol title_left amazon-text">
                    <!-- <h3>Manifest Creation Files<small></small></h3> -->
                </div>
                @if($processedXmlFile->count() != 0)
                    @if($showDeleteButtonQuery == 0)
                        <div class="col-md-12 col-12 title_left amazon-text text-right">
                            <a href="{{ route('delete.duplicate.file') }}"><button class="btn btn-danger">Delete Duplicate Orders</button></a>
                        </div>
                    @endif
                @endif
            </div>
...
<div class="x_title">
    ...
    Manifest Creation Files
      ...
      <form method="get" action="" class="d-flex align-items-center">
             ...
             <div class="">
             <button class=" btn-primary sub-ad" type="submit" style="margin:8px 0px 0px 0px !important">Go</a> </button>
             </div>
            </form>
      </div>
                        <div class="x_content">
