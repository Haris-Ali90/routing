      ...
      $(document).on('click','.toggle-button',function(){     
        ...
        function sendData(data,context) {
            ...
            //                console.log('in function');
                        ...
                        $.ajax({
                url: "<?php echo URL::to('/'); ?>/backend/amazon/failed/orders",
                type: 'POST',
				 ...
				 var r=$( "#select_address_type" ).find('option:selected').val();
                  if(r=="")
                   ...
                   $('.input-error').hide();
                    ...
                    $.ajax({
                            type: "POST",
                            url: "<?php echo URL::to('/'); ?>/backend/amazon/create/all/order",
...
<div class="right_col" role="main">
        ...
        @if ($message = Session::get('success'))
            ...
            <form method="get" action="" id="">   
                                ...
                                <div class="col-lg-3">
                                <input  style="width: 300px;height: 35px; margin-top:5px; margin-bottom:5px; border-radius: 5px; margin-right:5px;float: left" id="date_id" name="date" type="date"  placeholder='Select a date'  class="form-control" value=<?php echo $date;?>  >
                                </div>
                                        ...
                                        <button class="btn green-gradient sub-ad" id="search_btn" type="submit" style="margin-top:7px; margin-bottom:5px;  margin-right:5px;float: left" >Search </button>
                                         ...
                                         <button  style="margin-top:7px; margin-bottom:5px;  margin-right:5px;float: left" type="button" class="dselect  btn sub-ad btn-primary ">Create Selected Order</button>
                                         </div>
                  </div>
                                 </form>
