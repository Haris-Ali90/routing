...
@section('inlineJS')
    ...
    <script>
                        ...
                        buttons: {
                            'confirm': {
                                ...
                                action: function () {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ URL::to('backend/vancouver/create/all/order')}}",
                                        data: {ids: del_id},
        ...
        function sendDataSprint(data, context) {
            ...
            $.ajax({
                url: "{{ URL::to('backend/vancouver/failed/orders')}}",
                type: 'POST',
                beforeSend: function (request) {
                    return request.setRequestHeader('X-CSRF-Token', "{{ csrf_token() }}");
                },
                        ...
                        buttons: {
                            'confirm': {
                                ...
                                action: function () {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ URL::to('backend/vancouver/task')}}",
                                        data: {ids: del_id},
                                        beforeSend: function (request) {
                                           console.log(request)
    ...
    background-color: #000000ba; display: none"
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    if ($failed_orders->sprint_id == '') {
                                        ...
                                        echo "<button  data-id='" . $failed_orders->id . "' class='btn green-gradient toggle-button nonsprint'>Edit</button>";
                                    }
