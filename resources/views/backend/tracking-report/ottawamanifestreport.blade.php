...
@section('title', 'Ottawa Manifest Report')
...
// datatable init
let datatable = $('#ottawa-manifest-report').DataTable({
        ...
        @if ($message = Session::get('success'))
            ...
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3>Ottawa Manifest Report<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <form method="get" action="{{route('ottawa-manifest-report.data')}}" id="">
                    ...
                    <div class="table-responsive">
                        <table id="ottawa-manifest-report" class="table table-striped table-bordered">
