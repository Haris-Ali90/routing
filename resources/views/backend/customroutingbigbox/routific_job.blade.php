...
@section('title', 'Big Box Routifc Jobs Panel')
        ...
        <div class="">
            ...
            <div class="page-title">
                <div class="title_left amazon-text">
                    <!-- <h2>Big Box Routific Jobs<small></small></h2> -->
                </div>
            </div>
                     ...
                     <div class="col-lg-3">
                       <div class="form-group">
                              <label>Search By Date</label>     
                               <input type="date" name="date" required="" class="form-control" style="width:100% !important" placeholder="Search" value="2023-12-26">
                              </div>
                       </div>
               <div class="col-lg-6">
               <button  id="search" type="submit" class="btn sub-ad btn-primary every-add-button">Filter</button>
               </div>
                     </div>
