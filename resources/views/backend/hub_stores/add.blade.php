            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Attach HubStores</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                
                        </div>
                        <form action="{{ route('hub.stores.post') }}" method="post">
                            {{ csrf_field() }}
                           <div class="row d-flex align-items-center" >
                            <div class="col-lg-3">
                            <div class="form-group">
                                <label>Stores </label>
                                <input type="hidden" name="hub_id" id="hub_id" class="form-control" value="{{ $hub }}">
                                <select class="js-example-basic-multiple form-control" name="vendor_id[]"
                                        id="vendor_id" style="width: 65%;min-height: 33px !important;"
                                        multiple="multiple" required>
                                </select>
                            </div>
                           </div>
                           <div class="col-lg-6 d-flex align-items-center">
                           <button type="submit" class="btn sub-ad btn-primary" style="margin:10px 0px 0px 0px!important ">Add</button>
                           </div>
                            </div>
                        </form>
                    </div>
