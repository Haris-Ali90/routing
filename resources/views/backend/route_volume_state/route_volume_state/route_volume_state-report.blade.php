                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-md-6 col-xs-12">
                                ...
                                <select class="form-control" name="hub" id="hub">
                                    ...
                                    <option <?php if(isset($hubid)){if($hubid==17){echo "selected"; $hubname="CTC";}} ?> value="{{base64_encode(17)}}">CTC</option>
                                </select>
                            </div>
                            <div class="col-lg-3 col-md-6 col-xs-12 datepicker_wrap">
                                <label for="week_ww_yyyy">Select a week:</label>
                                <input name="weekpicker" type="text" id="week_ww_yyyy" class="form-control">
                            </div>
                            <div class="col-lg-1 col-md-2 col-xs-12">
                                <button type="submit" class="btn btn-primary" style="margin-top: 23px; width: 100%">GO</button>
                            </div>   
                            <div class="col-lg-5 col-xs-12" style="margin-top:22px;">
                                @if(isset($hubid))
                                    <input type="button" onclick="tableToExcel('export_table', 'W3C Example Table')" class="btn btn-success pull-right download-btn" value="Download Report" />
                                @endif
                            </div>
                        </div>
                    </div>
