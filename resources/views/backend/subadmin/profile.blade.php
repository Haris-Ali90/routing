                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach($rights as $right)
                                                            @if($right == 'subadmins')
                                                                <span>Sub Admin,</span>
                                                            @elseif($right == 'montreal_routes')
                                                                <span>Montreal Routes,</span>
                                                            @elseif($right == 'ottawa_routes')
                                                                <span>Ottawa Routes,</span>
                                                            @elseif($right == 'ctc_routes')
                                                                <span>Ctc Routes,</span>
                                                            @elseif($right == 'wm_routes')
                                                                <span>Walmart Routes</span>
                                                            @endif
                                                        @endforeach
                                                    </td>
                                                </tr>
