        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                        <h2>Mid Mile Route List<small></small></h2>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <button  id="search" type="submit" class="btn sub-ad btn-primary" style="margin:0!important">Submit</button>
                        </div>
                                    ...
                                    @foreach($routes as $key => $route)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class=' orange-gradient btn control-size' target='_blank' href='../../mi_job/route/{{$route->route_id}}/edit?date={{$date}}' title='Edit Route'>E</a>
...
{{--                                                <a class=' orange-gradient btn control-size' target='_blank' href='../route/{{$route->route_id}}/history' title='Route History'>RH</a>--}}
                ...
                <div class='modal-content'>
                    ...
                    <form action='../route/transfer' method="POST">
                        ...
                        <a type="submit" data-selected-row="false"  onclick="transfer()" class="btn green-gradient transfer-model-btn">
                            <?php if(in_array(null, $routeJoeyId)){ ?>
                                Assign
                            <?php }else{ ?>
                                Transfer
                            <?php } ?>
    ...
    <script>
        ...
        function initialize(id, date) {
            ...
            $.ajax({
                url: '../../mi_job/route/' + id + '/map?date='+ date,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
        ...
        $(document).on('click', '.details', function(e) {
            ...
            $.ajax({
                ...
                url: '../../mi_job/route/' +  routeId + '/detail?date=' + date,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    var i = 0;
