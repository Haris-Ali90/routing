                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <button type='button'
                                                            ...
                                                            data-engine="{{ $record->engine }}">Create Route
                                                        <i class='fa fa-eye'></i>
                                                    </button>
                                                    @endif
                                                    <button type='button' class='delete btn  red-gradient actBtn '
                                                            data-id="{{$record->id}},{{$record->engine}}">Delete
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (parseData.status == 200) {
                                ...
                                $('.alert-message').html('<div class="alert alert-success alert-green"><button style="color:#f5f5f5"; type="button" class="close" data-dismiss="alert"><strong><b><i  class="fa fa-close"></i><b></strong></button><strong>' + parseData.output + '</strong>');
                            } else {
