...
@section('content')
    ...
    <div class="right_col" role="main">
     ...
     <a class=' orange-gradient btn' target='_blank' href='../../../mid/mile/route/" . $counts[$j]->route_id . "/edit/hub/17' title='Edit Route'>E</a>
    ...
    <script>
        ...
        function currentMap(id) {
            ...
            $.ajax({
                url: '../../../mid/mile/route/' + id + '/remaining',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    // initialize map center on first point
        ...
        $(document).on('click', '.details', function(e) {
            ...
            $.ajax({
                ...
                url: '../../../mid/mile/route/' +  routeId + '/details',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    var i = 0;
                    ...
                    var heading = "<h4>R-" + data.routes[0].route_id + '-'+ startOrdinal + "</h4>";
                    ...
                    var heading = "<h4>R-" + data.routes[0].route_id + '-'+ endOrdinal + "</h4>";
                    var type = "<p>Type : dropoff</p>";
                    var name = "<p>Name : " + data.hub.title + "</p>";
                    var address = "<p>Address : " + data.hub.address + "</p>";
                    html += heading + type + name + address;
